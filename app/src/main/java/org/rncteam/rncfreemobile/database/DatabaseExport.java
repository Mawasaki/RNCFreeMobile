...
public class DatabaseExport extends Database {
    ...
    public void addExport(Export exp) {
        ...
        v.put(COL_EXPORT_NAME, exp.get_name());
        v.put(COL_EXPORT_DATE, exp.get_date());
        v.put(COL_EXPORT_NB, exp.get_nb());
        v.put(COL_EXPORT_NB_UMTS, exp.get_nb_umts());
        v.put(COL_EXPORT_NB_LTE, exp.get_nb_lte());
    ...
    private Export cToExport(Cursor c) {
        ...
        exp.set_name(c.getString(6));
        exp.set_date(c.getString(7));
        exp.set_nb(c.getString(8));
        exp.set_nb_umts(c.getString(9));
        exp.set_nb_lte(c.getString(10));
        exp.set_state(c.getString(11));
        exp.set_type(c.getString(12));
        exp.set_app_version(c.getString(13));
